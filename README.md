...
| Competitions | Explore challenges, awards, and student programmes. |
| Ambassador programmes | Find campus, community, and creator opportunities. |
| Student guides | Prepare for applications, internships, and events. |
...
- **Reviewed details:** Unknown information stays unknown instead of being guessed.
- **Local-first discovery:** The directory focuses on students and opportunities in Thailand.
- **No account required:** Save interesting listings locally in your browser.

## Opportunity status

| Status | Meaning |
| --- | --- |
| active | A current application or registration is supported by evidence. |
| upcoming | An official future opening or named cycle is confirmed. |
